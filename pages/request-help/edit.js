...
export default function editRequestHelp() {
  ...
  if (disablePage === true) {
    return (
      <Layout pageTitle="Edit Help Request">
        <RedirectPrompt message="You haven't submitted a help request." />
      </Layout>
    );
  }
  ...
  return (
    <>
      {session && (
        <Layout>
          <Head>
            <title>Edit Help Request | TolongCariKerja</title>
          </Head>
